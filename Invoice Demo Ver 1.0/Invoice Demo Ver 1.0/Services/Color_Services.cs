...
namespace Invoice_Demo_Ver_1._0.Services
{
    public static class Color_Services
    {
        ...
        public static void HighlightNRAObject(ExcelWorksheet worksheet, int row, int col)
        {
        ...
        public static void HighlightAzhurObject(ExcelWorksheet worksheet, int row, int col)
        {
        ...
        public static void HighlightCell(ExcelWorksheet worksheet, int row, int col)
        {
